...
const app = {
    ...
    songs: [{
            title: "Faded",
            author: "Alan Walker",
            path: "./asset/music/song0.mp3",
            image: "./asset/img/image0.jpg",
        },
        {
            title: "Believer",
        ...
        },
        {
            ...
            image: "./asset/img/image6.jpg",
        },
        {
            title: "Bones",
            author: "Imagine Dragons",
            path: "./asset/music/song7.mp3",
            image: "./asset/img/image7.jpg",
        },
        {
            title: "Demons",
            author: "Imagine Dragons",
            path: "./asset/music/song8.mp3",
            image: "./asset/img/image8.jpg",
        },
        {
            title: "Natural",
            author: "Imagine Dragons",
            path: "./asset/music/song9.mp3",
            image: "./asset/img/image9.jpg",
        },
        {
            title: "Whatever it takes",
            author: "Imagine Dragons",
            path: "./asset/music/song10.mp3",
            image: "./asset/img/image10.jpg",
        },
        {
            title: "Enemy",
            author: "Imagine Dragons",
            path: "./asset/music/song11.mp3",
            image: "./asset/img/image11.jpg",
        },
        {
            title: "Sugar",
            author: "Maroon 5",
            path: "./asset/music/song12.mp3",
            image: "./asset/img/image12.jpg",
        },
        {
            title: "Wellerman",
            author: "Nathen Evans",
            path: "./asset/music/song13.mp3",
            image: "./asset/img/image13.jpg",
        },
        {
            title: "Masked Heroes",
            author: "Vexento",
            path: "./asset/music/song14.mp3",
            image: "./asset/img/image14.jpg",
        },
        {
            title: "Nevada",
            author: "Vicetone",
            path: "./asset/music/song15.mp3",
            image: "./asset/img/image15.jpg",
        },
        {
            title: "Say You Do",
            author: "Tiên Tiên",
            path: "./asset/music/song17.mp3",
            image: "./asset/img/image17.jpg",
        },
    ],
